...
cmake -DCMAKE_INSTALL_PREFIX=../Installs -DVTKm_USE_DOUBLE_PRECISION=ON  -DVTKm_ENABLE_OPENMP=ON -DCMAKE_CXX_FLAGS="-fopenmp" -DCMAKE_BUILD_TYPE=Release ../VTK-m
make -j20 install
...
cmake -DVTKm_USE_DOUBLE_PRECISION=ON  -DVTKm_ENABLE_OPENMP=ON -DCMAKE_CXX_FLAGS="-fopenmp" -DVTKm_DIR=../Installs/lib/cmake/vtkm-2.1/ -DCMAKE_INSTALL_PREFIX=../Installs ../VTK-m/examples/contour-visualiser
make -j20
